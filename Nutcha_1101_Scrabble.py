...
#
import random
from Scrabble import CONSONANTS, HAND_SIZE, SCRABBLE_LETTER_VALUES, VOWELS
...
def get_word_score(word: str, n: int) -> int:
    ...
    returns: int >= 0
    """
    # TO DO ... <-- Remove this comment when your code this function
...
def is_valid_word(word: str, hand: dict, word_list: list) -> bool:
    ...
    #testcases
print(is_valid_word("hello", {'h': 1, 'e':1, 'l':2, 'o':1, 'u':1, 'i':1}, ["hello", "Nutcha"]))
print(is_valid_word("hello", {'h': 1, 'e':1, 'l':1, 'o':2, 'u':1, 'i':1}, ["hello", "Nutcha"]))